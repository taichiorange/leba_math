...
snr=2;   %高斯信道信噪比
L=16;  %CASCL译码器的列表长度
[crc_obj,crcdetector] = get_crc_objective(crc_len);%输出对应的CRC生成器与CRC校验器
...
for i_run = 1 : max_runs
        ...
        polar_info_cascl = CASCL_decoder(llr, L, K, frozen_bits, crc_obj,crcdetector, lambda_offset, llr_layer_vec, bit_layer_vec);
...
function [crc_obj,crc_det] = get_crc_objective(crc_length)
    switch crc_length
        case 4
            Polynomial = "x^4 + x + 1";
        case 6
